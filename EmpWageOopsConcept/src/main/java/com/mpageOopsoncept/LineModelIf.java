...
public class LineModelIf {
	...
	public static void main(String[] args) {
			...
			/**
			 * UC 1 Modelling a line based on (x,y) Co-ordinates
			 */
			int x1, x2, y1, y2;
			int a1, a2, b1, b2;
			...
			double res , res1 ; //UC 3 Comparing Both the Lines 
			...
			if (res == res1) {
				System.out.println("The two lines are equal"); //UC2-UC3 Two Lines are Equal
			}else { 
				if(res > res1) //UC 3-4 Using Object Orient Method to Compare both Lines
